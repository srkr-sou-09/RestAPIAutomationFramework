...
public class ExtentReportManager {
    ...
    public static String getReportNameWithTimeStamp(){
        ...
        return "TestReport_"+localDateTime.format(dateTimeFormatter);
    }
    ...
    public static void logHeaders(List<Header> headerList ){
        String[][]  arryayHeaders = headerList.stream()
                                            .map(header->  new String[]
                                                    {header.getName(),header.getValue()})
                        .toArray(String[][]::new);
        Setup.extentTest.get().info(MarkupHelper.createTable(arryayHeaders));
    }
}
